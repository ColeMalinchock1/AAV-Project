...
class RosNode(Node):
    def __init__(self, gui):
        ...
        self.gui = gui
        self.subscriber_ = self.create_subscription(Float64MultiArray, 'map_topic', self.gps_callback, 10)
...
class MapGUI:
    def __init__(self, root):
        ...
        self.map_widget.set_position(35.770728, -78.674779, marker=False)
